...
class ApproveAdoptionRequestDTOFactory(factory.Factory):
    class Meta:
        model = ApproveAdoptionRequestDTO

    user_id = "string"
    request_id = 1


class GetAdoptionRequestsListDTOFactory(factory.Factory):
    class Meta:
        model = GetAdoptionRequestsListDTO
