...
ALLOWED_HOSTS = [
    "pet-store-prod.apigateway.in",
    "pet-store-alpha.apigateway.in",
    "pet-store-beta.apigateway.in",
    "pet-store-gamma.apigateway.in",
    "pet-store-staging.apigateway.in",
    "127.0.0.1",
    "localhost"
]
...
LOGGING = {
    ...
    'formatters': {
        ...
        'console': {
            'format': "[%(request_id)s] [pet_store - "+os.environ.get("STAGE", "local")+
...
# ****************** App Source Config ******************
PET_STORE_SOURCE = "pet-store-source"
